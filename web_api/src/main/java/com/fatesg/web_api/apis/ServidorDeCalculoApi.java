...
public class ServidorDeCalculoApi implements ClienteDeCalculoFolhaInterface {
    ...
    private final int[] portas = { 1198, 1199 };

    // CONTROLE DO LOAD BALANCER
    ...
    // ESCOLHE A PRÓXIMA PORTA (ROUND ROBIN)
    private int obterProximaPorta() {
        int porta = portas[indiceAtual];

        indiceAtual = (indiceAtual + 1) % portas.length;

        System.out.println("Requisição enviada para porta: " + porta);
    ...
    private void conectar() throws IOException {
        ...
        int porta = obterProximaPorta();

        this.cliente = new Socket(
                JsonRPCConfig.JSON_RPC_SERVER_HOST,
                porta);
    ...
    private JsonRpcResponse<Object> enviar(JsonRpcRequest request) throws IOException, Exception {
        ...
        JsonRpcResponse<Object> response = (JsonRpcResponse<Object>) new Gson().fromJson(
                resJson,
    ...
    public FolhaDto calcularFolhaDePagamentoDoDepartamento(String arg0, byte arg1, short arg2) {
        ...
        throw new UnsupportedOperationException(
                "Unimplemented method 'calcularFolhaDePagamentoDoDepartamento'");
    }
